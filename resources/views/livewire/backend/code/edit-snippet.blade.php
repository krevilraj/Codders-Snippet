    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <form role="form" id="add_snippet" wire:submit.prevent="updateSnippet">
            ...
            <div class="card-body">
              ...
              <div class="form-group" wire:ignore>
                <label for="exampleInputEmail1">Snippet <small class="italic">(Note: Press CTRL + Q to covert into dynamic variable and it only works in Insert Code Snippet
                    <a href="/learn-about-dynamic-variable">Learn more..</a>)</small></label>

                <textarea name="template" cols="30" id="editor"
                          rows="10"> {{$template}}</textarea>
              </div>
